...
function EditItem() {
 ...
 <option value="non veg" >non veg</option>
                    ...
                    <button className='w-full bg-[#c55f50] text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-[#ba3824] hover:shadow-lg transition-all duration-200 cursor-pointer' disabled={loading}>
